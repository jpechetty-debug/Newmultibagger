...
class HRPAllocator:
    ...
    def calculate_hrp_weights(self, stocks_list: List[Dict[str, Any]], history_df: pd.DataFrame) -> List[Dict[str, Any]]:
        """
        ...
        common_symbols = [s for s in history_df.columns if s in [stock['Symbol'] for stock in stocks_list]]
